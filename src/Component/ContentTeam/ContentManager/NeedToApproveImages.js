...
const ApprovedImages = (props) => {
  ...
  //     };
  //     try {
  //       const endPoint = `https://api.admin-portal.dev.yourlmo.com/admin-dev/${empid}/${userRole}?status=aprvreassign`;
  ...
  return (
    <div>
      <Row justify="space-between" align="middle">
        <h3>Approve /Reject Shop Images</h3>
        <span>
          <Button
            loading={btn}
            className="m-1"
          ...
          {/* <Button
            loading={btn}
            className="m-1"
            onClick={()=>{approveAllImges("approve")}}
            type="primary"
          >
            ApproveAll
          </Button>
          <Button
            loading={btn}
            className="m-1"
            onClick={()=>{approveAllImges("reject")}}
            type="primary"
          >
           RejectAll
          </Button> */}
        ...
        {!loading && images && images.length > 0 ? (
                ...
                <Col lg={6}>
                  <div className="column">
                    ...
                    >
                      ...
                      <Radio value="reassign" style={{ color: "blue" }}>
                        Re-Assign
                      </Radio>
          ...
          <Row justify="center" className="my-5">
            {noimageFound && !loading ? (
              <Alert message="No images uploaded yet!" type="info" />
            ) : (
              <Spin
                className="row"
